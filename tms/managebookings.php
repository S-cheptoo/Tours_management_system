...
<html>
<head>
<title>KARA Tours| Admin manage Bookings</title>
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Bookings</h2>
						...
						<tbody>
<?php $sql = "SELECT tblbooking.BookingId as bookid,tblusers.FullName as fname,tblusers.MobileNumber as mnumber,tblusers.EmailId as email,tbldestinations.destinationName as dstname,tblbooking.destinationId as d_id,tblbooking.FromDate as fdate,tblbooking.ToDate as tdate,tblbooking.Comment as comment,tblbooking.status as status,tblbooking.CancelledBy as cancelby,tblbooking.UpdationDate as upddate from tblusers join  tblbooking on  tblbooking.UserEmail=tblusers.EmailId join tbldestinations on tbldestinations.destinationId=tblbooking.destinationId";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>		
						  <tr>
							...
							<td><a href="updatepackage.php?d_id=<?php echo htmlentities($result->d_id);?>"><?php echo htmlentities($result->dstname);?></a></td>
