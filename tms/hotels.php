...
{	?>
			<div class="rom-btm">
				<div class="col-md-3 room-left wow fadeInLeft animated" data-wow-delay=".5s">
					<img src="pacakgeimages/images<?php echo htmlentities($result->HotelPic);?>" class="img-responsive" alt="">
				</div>
				...
				<div class="col-md-3 room-right wow fadeInRight animated" data-wow-delay=".5s">
					<h5>KSh. <?php echo htmlentities($result->HotelPrice);?></h5>
					<a href="hotelsdetails.php?htl_id=<?php echo htmlentities($result->HotelId);?>" class="view">Details</a>
				</div>
